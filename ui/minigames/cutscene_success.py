"""
Success cutscene for surgery outcomes
"""
import pygame
import math

# Colors
SUCCESS_GREEN = (60, 200, 80)
TEXT_COL = (160, 160, 150)
MUTED_COL = (80, 80, 70)


class SuccessCutscene:
    """Success cutscene - shows when surgery is successful"""
    ...
    def __init__(self, screen, fonts, patient_name: str):
        ...
        # Cutscene content
        self.title = "SURGERY SUCCESSFUL"
        self.subtitle = "Patient Stabilized"
        self.lines = [
            f"The surgery on {patient_name} was a success.",
            "Vital signs are stabilizing.",
            "The patient is being moved to recovery.",
            "",
            "The family has been notified.",
            "A good outcome for a difficult case."
        ]
        self.color = SUCCESS_GREEN
